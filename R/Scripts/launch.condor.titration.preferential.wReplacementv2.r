...
# wReplacement v2 uses same extrapgrid definition as all other runs
...
launch_machine.stem = "/home/nicholasd/spatial.sampling.sim.manuscript/Titration_Preferential_wReplacement_v2/"
...
reps = 1:80 # which reps to use to calculate the indices
		...
		# create new directories for results: local & remote
			dir.create(paste0("Index/Titration_Preferential_wReplacement_v2/"),recursive=TRUE,showWarnings=FALSE)
